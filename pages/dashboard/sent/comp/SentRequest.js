...
function SentRequest() {
    ...
    return (
        <>
            {data.sentrequestdata && data.sentrequestdata.sentUsersdata && data.sentrequestdata.sentUsersdata.length > 0 ? <>
                <div>
                    ...
                    <div className='flex flex-col'>
...

                        {
                            ...
                            data.sentrequestdata?.sentUsersdata?.map((res, index) => {
                                return (
                                    <>
                                                ...
                                                <div className='w-full pt-[15px] 2xl:pt-[15px] xl:pt-[20px]'>
                                                    ...
                                                    <div className='flex justify-end items-center mt-[20px] 2xl:mt-[20px] xl:mt-[20px] mr-[20px] space-x-[10px]'>
                                                        <ul className='flex space-x-[10px]'>
                                                            ...
                                                            <li><Image width={23} height={23} src='/assests/dashboard/icon/accepted-right.svg' /></li>
                                                        </ul>
