                                    ...
                                    <div style={ProfileCard} className='inline-block lg:flex flex-col space-y-[15px]  2xl:w-[192px] w-[180px] xl:w-[170px] h-[327px] bg-[#FFF] rounded-[10px]'>
                                        <div className='flex justify-between pt-[10px]'>
                                            <ul className='pl-[10px] flex space-x-[10px]'>
                                                <li>
                                                    <Image alt='img' loading='lazy' width={17} height={14} src='/assests/Black/Couple2.svg' />
                                                </li>
                                                <li className='text-[10px]' style={Text4}>You & Her </li>
                                            </ul>
                                            <ul className='pr-[10px] flex space-x-[30px]'>
                                                <li>
                                                    <Image alt='img' loading='lazy' width={15} height={14} src='/assests/Black/Stars-2.svg' />
                                                </li>
                                                <li>
                                                    <Image alt='img' loading='lazy' width={3} height={14} src='/assests/Black/3Dots.svg' />
                                                </li>
                                            </ul>
                                        </div>
                                        <div className='flex justify-center '>
                                            <Image alt='img' loading='lazy' width={102} height={102} className='w-[102px] h-[102px] rounded-[50%]' src={item.profilePic} />
                                        </div>
                                        ...
                                        <div className='flex space-x-[15px] justify-center'>
                                            <div><Image alt='img' loading='lazy' width={40} height={40} className='w-[40px] h-[40px]' src='/assests/dashboard/icon/ignore-icon-2.svg' /></div>
                                            <div><Image alt='img' loading='lazy' width={40} height={40} className='w-[40px] h-[40px]' src='/assests/dashboard/icon/heart-icon-2.svg' /></div>
                                            <div><Image alt='img' loading='lazy' width={40} height={40} className='w-[40px] h-[40px]' src='/assests/dashboard/icon/send-icon-2.svg' /></div>
                                        </div>
                                    </div>
                                </>
                            )
