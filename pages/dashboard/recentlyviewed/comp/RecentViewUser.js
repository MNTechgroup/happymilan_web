                                                    ...
                                                    <div className='flex justify-between  h-[50px]'>
                                                        ...
                                                        <div className='pr-[8px]'>
                                                            <ul className='flex justify-evenly space-x-[10px] pr-[10px] pt-[10px]'>
                                                                ...
                                                                <li>
                                                                    <div onClick={() => HandleShortlist(res.viewerId.id)} className="cursor-pointer hover:bg-[#F2F7FF] p-[5px] rounded-[50%] relative top-[-5px]">
                                                                        <Image
                                                                            loading="lazy"
                                                                            width={15}
                                                                            height={14}
                                                    ...
                                                    <div className='mt-[10px] 2xl:mt-[10px] xl:mt-[5px] pl-[2px]'>
                                                        <div id="user-card">
                                                            <ul id="user-card-grid">
                                                                <li className='text-[14px] 2xl:text-[14px] xl:text-[13px]' style={ListText}><Image loading='lazy' alt='img' width={15} height={14} src='/assests/Black/RightTick.svg' className='inline pr-[5px]' />{"38,7"}</li>
                                                                <li className='text-[14px] 2xl:text-[14px] xl:text-[13px]' style={ListText}><Image loading='lazy' alt='img' width={15} height={14} src='/assests/Black/RightTick.svg' className='inline pr-[5px]' /> {res?.viewerId?.maritalStatus ? res?.viewerId.maritalStatus : "NA , NA"}</li>
                                                                <li className='text-[14px] 2xl:text-[14px] xl:text-[13px]' style={ListText}><Image loading='lazy' alt='img' width={15} height={14} src='/assests/Black/RightTick.svg' className='inline pr-[5px]' />{`${res?.viewerId?.religion ? res?.viewerId.religion : "NA"}, ${res?.viewerId?.cast ? res?.viewerId.cast : "NA"}`}</li>
                                                                <li className='text-[14px] 2xl:text-[14px] xl:text-[13px]' style={ListText}><Image loading='lazy' alt='img' width={15} height={14} src='/assests/Black/RightTick.svg' className='inline pr-[5px]' />{`${res?.viewerId?.address ? res?.viewerId?.address?.currentCity : "NA"} , ${res?.viewerId.address ? res?.viewerId?.address?.currentCountry : "NA"}`}</li>
                                                                <li className='text-[14px] 2xl:text-[14px] xl:text-[13px]' style={ListText}><Image loading='lazy' alt='img' width={15} height={14} src='/assests/Black/RightTick.svg' className='inline pr-[5px]' />{`${res?.viewerId?.motherTongue ? res.viewerId.motherTongue : "NA , NA"}  `}</li>
                                                                <li className='text-[14px] 2xl:text-[14px] xl:text-[13px]' style={ListText}><Image loading='lazy' alt='img' width={15} height={14} src='/assests/Black/RightTick.svg' className='inline pr-[5px]' />{res?.viewerId?.userProfessional ? res.viewerId.userProfessional?.jobTitle : "NA , NA"}</li>
                                                            </ul>
                                                        </div>
