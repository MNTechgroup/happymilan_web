...
function RecentViewUser() {
    ...
    const [userData , setuserdata] =  useState([
        {
            ...
            RequestSent : false,
            profilePic: "/assests/dashboard/view/view-1.svg",
            Activestatus: true,
            personal: {
                height: "32, 5’3”",
            ...
            images: {
                image1: "/assests/dashboard/view/view-1.svg",
                image2: "/assests/dashboard/view/view-2.svg",
                image3: "/assests/dashboard/view/view-3.svg",
                image4: ""
            }
        },
        {
            ...
            RequestSent : false,
            profilePic: "/assests/dashboard/view/view-2.svg",
            Activestatus: false,
            personal: {
                height: "32, 5’3”",
                marriagestatus: "Never Married",
            ...
            description: "I'd describe myself as someone who's reliable, trendy, smart and someone who always has a smile",
            images: {
                image1: "/assests/dashboard/view/view-2.svg",
                image2: "/assests/dashboard/view/view-3.svg",
                image3: "/assests/dashboard/view/view-1.svg",
                image4: ""
            }
        },
        {
            ...
            userName: "Praveen K",
            RequestSent : false,
            profilePic: "/assests/dashboard/view/view-3.svg",
            Activestatus: false,
            personal: {
                height: "32, 5’3”",
                marriagestatus: "Never Married",
            ...
            description: "I'd describe myself as someone who's reliable, trendy, smart and someone who always has a smile",
            images: {
                image1: "/assests/dashboard/view/view-3.svg",
                image2: "/assests/dashboard/view/view-2.svg",
                image3: "/assests/dashboard/view/view-1.svg",
                image4: ""
            }
    ...
    const HandleRequest = (id) =>{
        ...
        setuserdata((prev)=>{
            return prev.map((res)=>{
                if(res.id === id){
                    return {...res,RequestSent:!res.RequestSent}
                }
                return res;
            })
        })
                                        ...
                                        <div style={Box} className={`flex m-[10px] lg:w-[590px] 2xl:w-[631px] 2xl:h-[294px] xl:w-[540px] xl:h-[284px] bg-[#FFF]`}>
                                            <div className='w-[350px]'>
                                                <div className='p-[15px] w-full '>
                                                    ...
                                                    >
                                                        <SwiperSlide>
                                                            <Image width={197} height={258} className='w-[197px] h-[258px]' src={res.images.image1} />
                                                        </SwiperSlide>
                                                        <SwiperSlide>
                                                            <Image width={197} height={258} className='w-[197px] h-[258px]' src={res.images.image2} />
                                                        </SwiperSlide>
                                                        <SwiperSlide>
                                                            <Image width={197} height={258} className='w-[197px] h-[258px]' src={res.images.image3} />
                                                        </SwiperSlide>
                                                    </Swiper>
                                                </div>
                                            </div>
                                            <div className='w-full pt-[15px] 2xl:pt-[15px] xl:pt-[20px]'>
                                                ...
                                                <div className='flex justify-end items-center mt-[20px] 2xl:mt-[20px] xl:mt-[20px] lg:mt-0 mr-[20px] space-x-[10px]'>
                                                    <h1 className='text-[16px] 2xl:text-[16px] xl:text-[14px]' style={BoldText}>{res.RequestSent ? "Wait for his response" : "Are you impressed?"}</h1>
                                                    <button id={!res.RequestSent ? "grad-btn" : "req-sent"} className={`w-[134px] h-[40px] rounded-[10px] ${res.RequestSent ? "bg-[#EDEDED] text-[black]" : "bg-[#0F52BA] text-[white]"} bg-[#0F52BA] text-[#FFF]`}  onClick={()=>HandleRequest(res.id)}>{res.RequestSent ? "Sent" : "Send Request"} </button>
                                                </div>
                                            </div>
                                        </div>
