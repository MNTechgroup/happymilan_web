...
import RecentViewUser from './recentlyviewed/comp/RecentViewUser'
        ...
        <div className='h-full'>
          ...
          <div>
            <div className='relative 2xl:w-[715px] xl:w-[635px] m-[10px] flex justify-between'>
              ...
              <h1 className='p-[5px] relative 2xl:left-[40px] xl:left-[55px]'><span style={Text6}>New Matches</span><span style={Text5} className='pl-[10px]'>06</span> </h1>
