...
import GridUserProfile from './comp/GridUserProfile'
        ...
        <div>
          ...
          <div>
            <div className='relative 2xl:w-[715px] xl:w-[635px] m-[10px] flex justify-between'>
              ...
              <h1 className='p-[5px] relative 2xl:left-[40px] xl:left-[55px]'><span style={Text6}> <span className='text-[#0F52BA]'> 124 </span> Profiles Found For You!</span></h1>
