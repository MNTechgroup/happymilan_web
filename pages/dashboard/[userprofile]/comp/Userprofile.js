                ...
                <div className={`flex m-[10px] 2xl:w-[631px] 2xl:h-[294px] xl:w-[540px] xl:h-[284px] lg:w-full w-full bg-[#FFF]`}>
                    <div id='grad-btn' className='w-full h-[100px] 2xl:h-[138px] xl:h-[138px] md:h-[138px] lg:h-[138px] bg-[#0F52BA] rounded-[10px]'>
                        ...
                        <div className='grid place-items-center'>
                            ...
                            {user?.profilePic ? (
                                <Image alt="img" style={{objectFit:"cover"}} width={184} height={184} className='rounded-[50%] mt-[5px] lg:mt-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] lg:w-[184px] lg:h-[184px] 2xl:w-[184px] 2xl:h-[184px] xl:w-[160px] xl:h-[160px]' src={user.profilePic} />

                            ) : (
                                <div style={{width : "184px" , height:"184px", backgroundColor:"#F8FBFF", borderRadius:"50%"}} className='grid place-items-center'>
                                    <Image alt='not-found' style={{position:"relative", top:"30px"}} width={45} height={45} src={"/assests/dashboard/icon/NotFound-img.svg"} />
                        ...
                        <div className='space-y-[5px]'><div className='pt-[10px]'>
                            <ul className='flex justify-center items-center space-x-[8px] md:space-x-[40px]'>
                                ...
                                <li>
                                    <div className='flex items-center space-x-[10px]'>
                                        <Image alt="bag-icon" width={14} height={12} src='/assests/dashboard/icon/bag-icon.svg' />
