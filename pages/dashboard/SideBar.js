      ...
      <aside id="separator-sidebar" className=" hidden lg:block w-[250px] pb-[100px] fixed top-[80px] 2xl:left-[15px] 2xl:pl-0 xl:pl-[10px] xl:left-0 bg-[#FFF] z-40 w-64 h-full transition-transform translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-auto bg-[#FFF] dark:bg-gray-800">
          ...
          <ul className="space-y-[10px] pb-[20px] font-medium border-t  border-gray-200 dark:border-gray-700 p-[10px]">
            ...
            <li className='pt-[8px] flex items-center  '>
              <Image alt='right-tick' width={15} height={14} src='/assests/Black/RightTick.svg' />
            ...
            <li className='pt-[8px] relative left-[-1px] flex items-center '>

              <svg width="20" height="13" viewBox="0 0 20 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="Vector" d="M9.60588 9.6C10.552 9.6 11.3542 9.26888 12.0125 8.60663C12.6708 7.94436 13 7.14019 13 6.19413C13 5.24804 12.6689 4.44583 12.0066 3.7875C11.3444 3.12917 10.5402 2.8 9.59413 2.8C8.64804 2.8 7.84583 3.13112 7.1875 3.79337C6.52917 4.45564 6.2 5.25981 6.2 6.20587C6.2 7.15196 6.53112 7.95417 7.19337 8.6125C7.85564 9.27083 8.65981 9.6 9.60588 9.6ZM9.6 8.9C8.85 8.9 8.2125 8.6375 7.6875 8.1125C7.1625 7.5875 6.9 6.95 6.9 6.2C6.9 5.45 7.1625 4.8125 7.6875 4.2875C8.2125 3.7625 8.85 3.5 9.6 3.5C10.35 3.5 10.9875 3.7625 11.5125 4.2875C12.0375 4.8125 12.3 5.45 12.3 6.2C12.3 6.95 12.0375 7.5875 11.5125 8.1125C10.9875 8.6375 10.35 8.9 9.6 8.9ZM9.60358 12.4C7.51786 12.4 5.61667 11.8375 3.9 10.7125C2.18333 9.5875 0.883333 8.08333 0 6.2C0.883333 4.31667 2.18214 2.8125 3.89643 1.6875C5.61071 0.5625 7.51071 0 9.59643 0C11.6821 0 13.5833 0.5625 15.3 1.6875C17.0167 2.8125 18.3167 4.31667 19.2 6.2C18.3167 8.08333 17.0179 9.5875 15.3036 10.7125C13.5893 11.8375 11.6893 12.4 9.60358 12.4ZM9.6 11.7C11.4833 11.7 13.2125 11.2042 14.7875 10.2125C16.3625 9.22083 17.5667 7.88333 18.4 6.2C17.5667 4.51667 16.3625 3.17917 14.7875 2.1875C13.2125 1.19583 11.4833 0.7 9.6 0.7C7.71667 0.7 5.9875 1.19583 4.4125 2.1875C2.8375 3.17917 1.63333 4.51667 0.8 6.2C1.63333 7.88333 2.8375 9.22083 4.4125 10.2125C5.9875 11.2042 7.71667 11.7 9.6 11.7Z" fill={router.pathname === "/dashboard/recentlyviewed" ? "#0F52BA" : "black"} />
              </svg>
              <Link href="/dashboard/recentlyviewed"><h1 style={Text3} className={`text-[14px] pl-[6px] hover:text-[#0F52BA] ${router.pathname === "/dashboard/recentlyviewed" ? "text-[#0F52BA]" : ""}`}>Recently Viewed</h1></Link>
            </li>
            ...
            <li className='pt-[8px] flex items-center '>
              ...
              <Link href="/dashboard/shortlists">
                {notificatindot.newShortlists > 0 && <span style={{ color: 'red' }} className='relative top-[-4px] left-[-8px]'> ●</span>}
                <h1 onClick={HandleGOTO} style={Text3} className={` ${notificatindot.newShortlists > 0 && 'inline relative left-[-10px]'}  text-[14px] pl-[10px] hover:text-[#0F52BA] ${router.pathname === "/dashboard/shortlists" ? "text-[#0F52BA]" : ""}`}>Shortlists</h1>
              </Link>
            ...
            <li className='pt-[8px] flex items-center '>
              <svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="Vector" d="M0 14V0L16.6033 7L0 14ZM0.636364 13.0165L14.9545 7L0.636364 0.954545V5.81405L5.8719 7L0.636364 8.15702V13.0165Z"
