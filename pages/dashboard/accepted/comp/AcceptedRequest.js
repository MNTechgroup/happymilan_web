    ...
    const userData = [
        {
            id: 1,
            userName: "Jash Patel",
            profilePic: "/assests/dashboard/request/accepted/accepted-1.svg",
            Activestatus: true,
            personal: {
                height: "32, 5’3”",
        ...
        {
            id: 2,
            userName: "Rihan Sharma",
            profilePic: "/assests/dashboard/request/accepted/accepted-2.svg",
            Activestatus: false,
            personal: {
                height: "32, 5’3”",
                marriagestatus: "Never Married",
            ...
            description: "I'd describe myself as someone who's reliable, trendy, smart and someone who always has a smile",
            images: {
                image1: "/assests/dashboard/request/accepted/accepted-2.svg",
                image2: "",
                image3: "",
                image4: ""
            }
        },
        {
            ...
            profilePic: "/assests/dashboard/request/accepted/accepted-3.svg",
            Activestatus: false,
            personal: {
                height: "32, 5’3”",
                marriagestatus: "Never Married",
                                            ...
                                            <div className='w-full pt-[15px] 2xl:pt-[15px] xl:pt-[20px]'>
                                                ...
                                                <div className='flex justify-end items-center mt-[20px] 2xl:mt-[20px] xl:mt-[20px] mr-[20px] space-x-[10px]'>
                                                    <ul className='flex space-x-[10px]'>
                                                        ...
                                                        <li><img src='/assests/dashboard/icon/accepted-right.svg' /></li>
                                                    </ul>
