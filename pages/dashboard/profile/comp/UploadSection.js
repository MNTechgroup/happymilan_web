...
function UploadSection() {
    ...
    const userData = [
        {
            id: 1,
            image: "/assests/pic/Rectangle379.svg"
        },
        {
            id: 2,
            image: "/assests/pic/Rectangle382.svg"
        },
        {
            id: 3,
            image: "/assests/pic/Rectangle381.svg"
        },
        {
            id: 4,
            image: "/assests/pic/Rectangle380.svg"
        },
        {
            id: 5,
            image: "/assests/pic/Rectangle383.svg"
        },
    ]
    const userVideo = [
        {
                ...
                <div className='w-[300px] 2xl:w-[300px] xl:w-[250px]'>
                    <div>
                        ...
                        {ActiveSection === 1 ? <>
                            ...
                            <>
                                <div>
                                    <Image alt='user-img' width={300} height={381} onClick={handleClickOpen} className='cursor-pointer' src='/assests/dashboard/user/user-image-1.svg' />
                                </div>
                            ...
                            <DialogContent className='w-[600px] h-[650px] 2xl:w-[600px] 2xl:h-[650px] xl:w-[600px] xl:h-[650px] bg-[black] '>
                                <div className='mt-[20px]'>
                                    ...
                                    <div className='flex justify-center  space-x-[70px] 2xl:space-x-[70px] xl:space-x-[100px]'>
                                            ...
                                            <ul className='flex  flex-col space-y-[20px] 2xl:space-y-[20px] xl:space-y-[20px]'>
                                                ...
                                                {/* {
                                                    TheData.map((res) => {
                                                        return (
                                                            <>
                                                                <li onClick={() => SetcurrentSelectedImage(res.id)}><Image width={74} height={74} className={`cursor-pointer w-[74px] h-[74px] 2xl:w-[74px] 2xl:h-[74px] xl:w-[60px] xl:h-[60px] rounded-[10px] ${currentSelectedImage === res.id ? "" : "opacity-20"}`} src={res.image} /></li>
...

                                                {
                                                    selector && selector.data && selector.data.userProfilePic ? (
                                                        selector.data.userProfilePic.map((res, index) => (
                                                            <li onClick={()=>HandleImageClick(res,index)}><Image width={74} height={74} className={`cursor-pointer w-[74px] h-[74px] 2xl:w-[74px] 2xl:h-[74px] xl:w-[60px] xl:h-[60px] rounded-[10px] ${currentSelectedImage === index ? "" : "opacity-20"}`} src={res.url} /></li>
                                        ...
                                        <div>
                                            <div>
                                                <Image alt='zoomIcon' width={20} height={20} src='/assests/dashboard/icon/zoom-icon.svg' className='absolute right-[80px] 2xl:right-[80px] xl:right-[90px] mt-[35px] 2xl:mt-[35px] xl:mt-[35px]' />
                                            </div>

                                            <Image alt='image' style={{objectFit:"cover"}} width={350} height={470} className='w-[350px] h-[480px] 2xl:w-[350px] 2xl:h-[470px] xl:w-[300px] xl:h-[420px]' src={showImage} />
                    ...
                    <div className='flex justify-between'>
                        ...
                        <div className='flex items-center space-x-[10px] pt-[10px]'>
                            <h1>Upload</h1>
                            <Image alt='drag-drop' width={34.818} height={24} onClick={handleClickOpenUpload} className='cursor-pointer w-[34.818px] h-[24px]' src='/loginassests/register-icons/Drag-Drop.svg' />
                            <Dialog
                                open={openUpload}
                                    ...
                                    <div className='space-y-[20px]'>
                                        <div className='flex items-center justify-between space-x-[20px]'>
                                            <div className='flex items-center space-x-[20px]'>
                                                <Image alt='userProfile' width={47} height={47} className="w-[47px] h-[47px]" src="/assests/dashboard/user/userProfile.svg" />
                                        ...
                                        <div className=''>
                                            ...
                                            <div className='pt-[20px] flex space-x-[28px] justify-center'>
                                                <button style={Text3} onClick={handleCloseUpload} className='w-[126px] h-[44px] rounded-[8px] bg-[#FFF] border-[1px] border-[#0F52BA] text-[#000]'>Close</button>
                                                <button id='grad-btn' style={Text3} onClick={handleCloseUpload} className='w-[126px] h-[44px] rounded-[8px] bg-[#0F52BA] border-[1px] border-[#0F52BA] text-[#FFF]'>Publish</button>
                                            </div>
                                        </div>
                                    </div>
                                </DialogContent>
