                ...
                <div className='relative 2xl:left-0 xl:left-[20px] 2xl:pl-[25px] xl:pl-[30px] 2xl:mt-[-15px] xl:mt-[-16px] flex flex-wrap  2xl:space-x-[27px] xl:space-x-[15px] space-y-[25px]'>
...

                    {
                        userData?.map((item) => {
                            return(
                            <>
                            <div style={ProfileCard} className=' flex flex-col space-y-[15px]  2xl:w-[189px] w-[189px] xl:w-[170px] h-[327px] bg-[#FFF] rounded-[10px]'>
                        ...
                        <div className='flex justify-center space-x-[21px]'>
                            <div className='w-[40px] bg-[#0F52BA] h-[40px] grid place-items-center rounded-full border-[1px] border-[#0F52BA]'>
