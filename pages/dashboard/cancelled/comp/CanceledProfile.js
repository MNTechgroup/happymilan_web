...
function CanceledProfile() {
    ...
    const userData = [
        {
            id: 1,
            userName: "Kalpesh Mistry",
            profilePic: "/assests/dashboard/ignore/ignore-1.svg",
            Activestatus: true,
            personal: {
                height: "32, 5’3”",
            ...
            images: {
                image1: "/assests/dashboard/ignore/ignore-1.svg",
                image2: "/assests/dashboard/ignore/ignore-2.svg",
                image3: "/assests/dashboard/ignore/ignore-3.svg",
                image4: ""
            }
        },
        {
            id: 2,
            userName: "Atul Khatri",
            profilePic: "/assests/dashboard/ignore/ignore-2.svg",
            Activestatus: false,
            personal: {
                height: "32, 5’3”",
                marriagestatus: "Never Married",
            ...
            description: "I'd describe myself as someone who's reliable, trendy, smart and someone who always has a smile",
            images: {
                image1: "/assests/dashboard/ignore/ignore-2.svg",
                image2: "/assests/dashboard/ignore/ignore-3.svg",
                image3: "/assests/dashboard/ignore/ignore-1.svg",
                image4: ""
            }
        },
        {
            id: 3,
            userName: "Nilesh Suthar",
            profilePic: "/assests/dashboard/ignore/ignore-3.svg",
            Activestatus: false,
            personal: {
                height: "32, 5’3”",
                marriagestatus: "Never Married",
            ...
            description: "I'd describe myself as someone who's reliable, trendy, smart and someone who always has a smile",
            images: {
                image1: "/assests/dashboard/ignore/ignore-3.svg",
                image2: "/assests/dashboard/ignore/ignore-2.svg",
                image3: "/assests/dashboard/ignore/ignore-1.svg",
                image4: ""
            }
    ...
    return (
        <>
                                        ...
                                        <div style={Box} className={`flex m-[10px] lg:w-[590px] 2xl:w-[631px] 2xl:h-[294px] xl:w-[540px] xl:h-[284px] bg-[#FFF]`}>
                                            <div className='w-[350px]'>
                                                <div className='p-[15px] w-full '>
                                                    ...
                                                    >
                                                        <SwiperSlide>
                                                            <Image alt='img-1' width={197} height={258} className='w-[197px] h-[258px]' src={images.image1} />
                                                        </SwiperSlide>
                                                        <SwiperSlide>
                                                            <Image alt='img-2' width={197} height={258} className='w-[197px] h-[258px]' src={images.image2} />
                                                        </SwiperSlide>
                                                        <SwiperSlide>
                                                            <Image alt='img-3' width={197} height={258} className='w-[197px] h-[258px]' src={images.image3} />
                                                        </SwiperSlide>
                                                    </Swiper>
                                                </div>
                                            </div>
                                            <div className='w-full pt-[15px] 2xl:pt-[15px] xl:pt-[20px]'>
                                                                ...
                                                                >
                                                                    <div className='bg-[#FFF] rounded-[10px] w-[128px] h-[150px]'>
                                                                        ...
                                                                        <ul className='flex flex-col justify-center space-y-[12px] ml-[12px] '>
                                                                            ...
                                                                            <li style={Text3} onClick={handleClickOpen} className='cursor-pointer flex  items-center space-x-[12px] text-[14px]'> <Image alt='img' width={12} height={14} src='/assests/dashboard/icon/copy-icon.svg' /> <p>Copy URL</p></li>
                                                                        </ul>
                                                ...
                                                <div className='mt-[10px] 2xl:mt-[10px] xl:mt-[5px] pl-[2px]'>
                                                    <div id="user-card">
                                                        <ul id="user-card-grid">
                                                            <li className='text-[14px] 2xl:text-[14px] xl:text-[13px]' style={ListText}><Image alt='mark' width={15} height={14} src='/assests/Black/RightTick.svg' className='inline pr-[5px]' />{res.personal.height}</li>
                                                            <li className='text-[14px] 2xl:text-[14px] xl:text-[13px]' style={ListText}><Image alt='mark' width={15} height={14} src='/assests/Black/RightTick.svg' className='inline pr-[5px]' />{res.personal.cast}</li>
                                                            <li className='text-[14px] 2xl:text-[14px] xl:text-[13px]' style={ListText}><Image alt='mark' width={15} height={14} src='/assests/Black/RightTick.svg' className='inline pr-[5px]' />{res.personal.language}</li>
                                                            <li className='text-[14px] 2xl:text-[14px] xl:text-[13px]' style={ListText}><Image alt='mark' width={15} height={14} src='/assests/Black/RightTick.svg' className='inline pr-[5px]' />{res.personal.marriagestatus}</li>
                                                            <li className='text-[14px] 2xl:text-[14px] xl:text-[13px]' style={ListText}><Image alt='mark' width={15} height={14} src='/assests/Black/RightTick.svg' className='inline pr-[5px]' />{res.personal.location}</li>
                                                            <li className='text-[14px] 2xl:text-[14px] xl:text-[13px]' style={ListText}><Image alt='mark' width={15} height={14} src='/assests/Black/RightTick.svg' className='inline pr-[5px]' />{res.personal.profession}</li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <div className='flex justify-end items-center mt-[20px] lg:mt-0 2xl:mt-[20px] xl:mt-[20px] mr-[20px] space-x-[10px]'>
                                                    <ul className='flex space-x-[10px]'>
                                                        ...
                                                        <li>
                                                            <Image alt='dislike-icon' width={24} height={23} src='/assests/Black/dislike-2.svg' />
            ...
            <ShareModal data={data} isOpen={isModalOpen} onClose={closeModal} />
