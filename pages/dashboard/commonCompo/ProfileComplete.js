...
function ProfileComplete() {
  ...
  return (
    <>
      <div className='2xl:mt-[-30px] xl:mt-[-25px] w-[300px] 2xl:w-[300px] xl:w-[280px] h-[219px]' style={Box}>
        <div className='text-center flex flex-col justify-center items-center mt-[-10px] 2xl:space-y-[3px] xl:space-y-[5px] items-center p-[30px]'>
          ...
          <button id='grad-btn' style={Text3} className='text-[14px] 2xl:w-[158px] 2xl:h-[44px] xl:w-[150px] xl:h-[44px]   rounded-[10px] bg-[#0F52BA] text-[white]'>Add Photos</button>
        </div>
      </div>
    </>
  )
