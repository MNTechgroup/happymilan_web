                            ...
                            <div className=' lg:pb-0 pb-[60px] mt-[100px] w-full  lg:w-full 2xl:w-[834px] xl:w-[834px]'>
                                ...
                                <div className=' w-full h-full mt-[40px] grid place-items-center'>
                                    ...
                                    <div className=' mt-[24px] w-[834px] relative left-[-5px]'>
                                        <div className='w-full h-[110px] border-[1px] border-[#E9E9E9] rounded-[14px]'>
                                            <div>
                                            ...
                                            <div className='grid place-items-end relative top-[-10px] right-[19px]'>
                                    ...
                                    <div className=' 2xl:w-[834px] xl:w-[634px] lg:w-[834px] mt-[38px]'>
                                        <div className='relative left-[-60px] 2xl:left-[-20px] xl:left-[-20px] 2xl:w-full xl:w-full  xl:w-full m-[0px] flex justify-between'>
                                            ...
                                            <div className='flex space-x-[10px]'>
                                                <div onClick={() => router.push("/successstories")} className='flex items-center space-x-[16px]' >
                                                    <h1 style={Text5} className='cursor-pointer text-[16px] dark:text-[#FFF] text-[#BABABA]'>More Stories</h1>
                                        ...
                                        <div className="w-full relative 2xl:left-[-60px] xl:left-[70px] left-[40px] top-[20px]">
                                            <div className='flex relative 2xl:left-0 xl:left-[-90px] 2xl:space-x-[25px] xl:space-x-[10px] lg:space-x-[25px]'>
                                                <div>
                                                    <Image alt='story-1' className='2xl:w-[260px] 2xl:h-[381px] xl:w-[250px] xl:h-[280px] lg:w-[200px] lg:h-[220px] ' loading='lazy' width={260} height={381} src={"/assests/storySec/stry-1.svg"} />
                                                </div>
                                                <div>
                                                    <Image alt='story-1' className='2xl:w-[260px] 2xl:h-[381px] xl:w-[250px] xl:h-[280px] lg:w-[200px] lg:h-[220px] ' loading='lazy' width={260} height={381} src={"/assests/storySec/stry-2.svg"} />
                                                </div>
                                                <div>
                                                    <Image alt='story-1' className='2xl:w-[260px] 2xl:h-[381px] xl:w-[250px] xl:h-[280px] lg:w-[200px] lg:h-[220px] ' loading='lazy' width={260} height={381} src={"/assests/storySec/stry-3.svg"} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
