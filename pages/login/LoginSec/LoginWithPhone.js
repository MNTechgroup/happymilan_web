        ...
        <>
            ...
            <div className='w-full h-full grid place-items-center'>
                ...
                <div className='relative top-[10px] 2xl:top-[20px] xl:top-[10px] flex flex-col 2xl:gap-y-[10px] xl:gap-y-[10px] gap-y-[10px] 2xl:my-[10%] xl:my-[50px]'>
                    ...
                    <div>
                        <button id='grad-btn' className='w-[300px] 2xl:h-[50px] xl:h-[45px] h-[50px] rounded-[8px] bg-[#0F52BA] text-[#FFF] hover:opacity-[0.95]'>Login</button>
                    </div>
                </div>
                ...
                <div className='flex items-center justify-center gap-x-[30px] mt-[-10px] relative 2xl:top-[-9px] xl:top-[-7px]'>
                    ...
                    <div className="cursor-pointer xl:w-[45px] xl:h-[45px] 2xl:w-[50px] 2xl:h-[50px]">
                        {/* <img className="2xl:w-[30px] 2xl:h-[30px] xl:w-[20px] h-[20px]" src="/assests/Blue/Message.svg" /> */}
                        {rendercomponent != 2 ?
                            <div className="2xl:w-[50px]  h-[50px] w-[50px] 2xl:h-[50px] xl:w-[45px] xl:h-[45px] border-[1px] rounded-[50px] border-[#D4D4D4] grid place-items-center">
                            ...
                            :
                            <div id='grad-btn' className="bg-[#0F52BA] 2xl:w-[50px]  h-[50px] w-[50px] 2xl:h-[50px] xl:w-[45px] xl:h-[45px] border-[1px] rounded-[50px] border-[#D4D4D4] grid place-items-center">
