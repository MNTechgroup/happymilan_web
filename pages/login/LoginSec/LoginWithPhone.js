        ...
        <>
            ...
            <div className='w-full h-full grid place-items-center'>
                ...
                <div className='relative top-[10px] 2xl:top-[20px] xl:top-[10px] flex flex-col 2xl:gap-y-[10px] xl:gap-y-[10px] gap-y-[10px] 2xl:my-[10%] xl:my-[50px]'>
                    <h1 style={TextStyle} className='mb-[30px]'>Sign in via Mobile</h1>
                    <div>
                        <input type='number' id="number-input" placeholder='Enter Mobile Number' className='focus:border-[1px] focus:border-[black] outline-none border-[1px] pl-[20px] border-[#E6E6E6] rounded-[8px] w-[300px] 2xl:h-[50px] h-[50px] xl:h-[45px]' />
                    </div>
                    <div>
                        <input placeholder='Enter Password' className='focus:border-[1px] focus:border-[black] outline-none border-[1px] pl-[20px] border-[#E6E6E6] rounded-[8px] w-[300px] 2xl:h-[50px] h-[50px] xl:h-[45px]' />
                    </div>
                    <div>
                        <h1 style={ResetPassword}>Reset Password</h1>
                    </div>
                    <div>
                        <button className='w-[300px] 2xl:h-[50px] xl:h-[45px] h-[50px] rounded-[8px] bg-[#0F52BA] text-[#FFF] hover:opacity-[0.95]' onClick={HandleRegister}>Login</button>
                    </div>
                </div>
                <div className='flex items-center justify-center mt-[23px] 2xl:mt-[-18px]   xl:mt-[-61px]'>
                ...
                <div className='flex items-center justify-center gap-x-[30px] mt-[-10px] relative 2xl:top-[-10px] xl:top-[-8px]'>
                    ...
                    <div className="cursor-pointer xl:w-[45px] xl:h-[45px] 2xl:w-[50px] 2xl:h-[50px]">
                        ...
                        {rendercomponent != 2 ?
                            ...
                            :
                            <div className="bg-[#0F52BA] 2xl:w-[50px]  h-[50px] w-[50px] 2xl:h-[50px] xl:w-[45px] xl:h-[45px] border-[1px] rounded-[50px] border-[#D4D4D4] grid place-items-center">
...
{/* <div className='flex items-center justify-center gap-x-[30px] mt-[-10px] relative 2xl:top-[-10px] xl:top-[-8px]'>
                    ...
                    <div className="xl:w-[45px] xl:h-[45px] 2xl:w-[50px] 2xl:h-[50px]">
                        {rendercomponent != 1 ?
                            ...
                            :
                            <div className="bg-[#0F52BA] 2xl:w-[50px] 2xl:h-[50px]  h-[50px] w-[50px] xl:w-[40px] xl:h-[40px] border-[1px] rounded-[50px] border-[#D4D4D4] grid place-items-center">
                    ...
                    <div className="xl:w-[45px] xl:h-[45px] 2xl:w-[50px] 2xl:h-[50px]">
                        <div onClick={() => setrendercomponent(2)} className="2xl:w-[50px] 2xl:h-[50px] h-[50px] w-[50px] xl:w-[40px] xl:h-[40px] border-[1px] rounded-[50px] border-[#D4D4D4] grid place-items-center">
