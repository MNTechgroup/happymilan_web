            ...
            <div className='w-full h-full grid place-items-center'>
                <div className='w-full mt-[100px]  grid place-items-center pt-[80px]'>
                    <div className=''>                   
                        ...
                        <h1 style={PagginationText} className='relative bottom-[40px] text-[18px]'>Happy Milan Blogs</h1>
                                
                            <div class="2xl:w-[1100px] xl:w-[100%] lg:w-full md:w-full   mx-auto flex flex-wrap">
                                <img alt="blog" class="lg:w-[359px] mr-[10px] w-full lg:h-[359px] h-64 object-cover object-center rounded" src="/assests/common/blog-img-1.svg" />
                                <div class="lg:w-1/2 md:w-full ml-[10px]  w-full lg:pl-10 lg:py-0 mt-6 lg:mt-0">
                                    <div>
                                        <h1 className=' lg:w-[100%] 2xl:w-[700px] xl:w-[700px] lg:text-[24px] text-[20px]' style={Title}>When the Tudor king fell for a young lady-in-waiting, Anne Boleyn, who possessed eyes "</h1>
                                        <p style={Date}>10 July 2023,</p>
                                    </div>
                                    <div className='pt-[38px]'>
                                    <img className='inline' src='/assests/common/blog-1-profile.svg' />
                                ...
                                <div className='w-full lg:w-auto grid place-items-center lg:block pt-[20px]'>
                                    <Link href="/blog/1"> <button style={Content} className='w-[214px] h-[50px] rounded-[24px] bg-[#F8F8F8] inline'><span className='pr-[15px]'>Read Full Article</span> <img className='inline' src='/assests/common/blog-arrow.svg' /></button></Link>
                                </div>

                                    </div>
                                    <div className='w-full h-[1px] bg-[black] lg:w-full 2xl:w-[690px] xl:w-[690px] md:w-[90%] mt-[45px]'></div>
                                </div>
                            </div>
                        </div>
                    </div>
