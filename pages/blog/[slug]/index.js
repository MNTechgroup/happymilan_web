            ...
            <div className="mt-[80px] w-full h-full grid place-items-center">
                <div className="pt-[50px] xl:w-[980px] 2xl:w-[1100px]">
                    <div className="w-[100px] fixed  right-16 grid place-items-center ">
                        <img className="lg:block hidden cursor-pointer" onClick={() => router.back()} src="/assests/common/arrow-back.svg" />
                    </div>
                    <div className="lg:w-[850px] 2xl:w-[850px] xl:w-[850px] w-full h-full">
                        ...
                        <div className="pt-[30px]">
                            <img src="/assests/pic/Blog-photo-1.svg" />
                            <div className="pt-[30px]">
...
{/* Dialog Box  */}
{/* <div className="absolute w-full h-full top-0 grid place-items-center border-2 border-[black]">
<div
        // open={
        ...
        className=" bg-[white] border-2 border-[black] w-[550px] grid place-items-center"
      > 
      <div className="w-full ">
        <div className="grid place-items-center">
         ...
         <div className="lg:w-[445px] w-full items-center flex  justify-between">
            ...
            <div>
                <img className="cursor-pointer"  onClick={() => handleOpen(null)} src="/assests/social/close.svg" />
            </div>
         </div>
