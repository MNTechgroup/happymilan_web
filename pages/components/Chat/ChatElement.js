        ...
        >
            ...
            <Stack direction="row" alignItems='center' justifyContent='space-between'>
                <Stack direction='row' spacing={0}>
                    <div onClick={HandleOpenChat} className={`${userData?.id == selectedUser ? "bg-[#F4F9FF]" : ""} hover:bg-[#F4F9FF] cursor-pointer p-[10px] rounded-[10px] w-[278px] flex space-x-[19px]  items-center`}>
                        {profilePic ?
