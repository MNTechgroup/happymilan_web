            ...
            <div className="fixed inset-0 flex items-center justify-center z-50">
                ...
                <div className="grid place-items-center relative z-10 bg-white rounded-lg shadow-lg p-6 max-w-[505px] md:h-[80%] lg:h-[281px]">
                    <div className='w-[427px] flex flex-col items-center justify-center space-y-[25px]'>
                        <div className=''>
                            <Image height={38} width={38} alt='right-icon' src="/assests/common/resetpassword-Modal.svg" />
                        </div>
                        ...
                        <div className='text-center'>
                            <button id='grad-btn' className='w-[172px] h-[50px] text-[white] rounded-[10px]' onClick={HandleExlopre}>Back to login</button>
                        </div>
                    </div>
                </div>
