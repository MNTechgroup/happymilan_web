...
function CommonNavbar() {
    ...
    // const ProfileImage = "https://lh3.googleusercontent.com/a/ACg8ocLB8rJACHuFx8vVJuewdpkdGzUS0Jc6fCqNRLjhjMKp=s96-c"
    // const HandleLogout = () =>{
    //     signOut({callbackUrl:"/"})
    // }
    const navList = (
                            ...
                            <SpeedDial placement="top">
                                <SpeedDialHandler>
                                    ...
                                    <img
                                        src={ProfileImage}
                                        alt="img"
                                        className="mr-4  relative left-[15px] w-[39.22px] h-[39.22px] rounded-full"
                                    />
