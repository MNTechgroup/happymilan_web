    ...
    return (
        <>
         <Sidebar/>
            ...
            <div className='hidden xl:pb-[50px] 2xl:mt-[-5px] 2xl:pb-[160px] grid place-items-center lg:block xl:mt-[1%]   w-auto pb-[200px]' style={divStyle} id=''>
             ...
             <div className='flex flex-col-reverse md:flex-col-reverse justify-evenly lg:flex-row justify-center'>
                   ...
                   <div id='home-title' className='flex items-center m-5 items-center lg:w-[475px]' >
                       <div className='lg:relative top-[18%] 2xl:top-[14%] xl:top-[5%] right-[5%]'>
                           <div className='relative py-[80px]  lg:p-10'>
                               <h1 className='lg:leading-[50px] text-[#FFF] text-[20px] w-[300px] md:text-[44px] md:w-full lg:w-full lg:text-[44px]'>Discover Your Perfect Match with HappyMilan.</h1>
                               ...
                               <button className='w-[231px] h-[60px] lg:w-[231px] lg:h-[60px] 2xl:w-[231px] 2xl:h-[60px] xl:w-[220px]  mt-[40px] xl:mt-[30px] flex items-center justify-center' onClick={() => router.push("/login")} >Free Registration <img className='ml-[15px]' src='/vector.svg' /></button>
                           </div>
                       </div>
                   </div>
               </div>
             ...
             <div className='flex flex-col-reverse md:flex-col-reverse justify-evenly lg:flex-row justify-center'>
                   ...
                   <div id='home-title' className='flex items-center m-5 items-center lg:w-[475px]' >
                       <div className='lg:relative top-[18%] right-[5%]'>
                           <div className='relative py-[80px]  lg:p-10'>
                               <h1 className='text-[#fff]  lg:leading-[50px] p-1 text-[20px] w-[300px] md:text-[44px] md:w-full lg:w-full lg:text-[44px]'>Discover Your Perfect Match with HappyMilan.</h1>
                               <p className='lg:w-[432px] text-[#fff] lg:h-[76px] mt-[30px]'>Welcome to Matrimoney, the premier online platform for finding your perfect life partner! We understand that finding a compatible partner is one of life's most important journeys, and we are here to make that process seamless, enjoyable, and successful.</p>
                               <button className='w-[231px] h-[60px] lg:w-[231px] lg:h-[60px] 2xl:w-[231px] 2xl:h-[60px] xl:w-[220px]  mt-[40px] xl:mt-[30px] flex items-center justify-center' onClick={() => router.push("/login")} >Free Registration <img className='ml-[15px]' src='/vector.svg' /></button>
                    ...
                    <div>
                        ...
                        <section className='h-[470px] w-full md:text-left lg:text-left p-10'>
                            <div className='lg:relative top-[35px] lg:top-[48px] lg:right-[25px]'>
                                <h1 id='sec-2-title' className='text-[32px] lg:w-[423px] lg:h-[131px]'>
                ...
                <div className=' w-full flex flex-col md:flex-col md:items-center lg:flex-row justify-center my-[13%]'>
                    ...
                    <div className=' relative w-full md:w-[410px] h-full lg:left-[0px] lg:left-[30px] top-[19px]' id='sec-3-content'>
                        <h1 className='lg:text-left text-center lg:w-[403px] text-[20px] md:text-[32px] lg:text-[32px] mb-10' id='sec-3-h1'>Why you should register with us?</h1>
