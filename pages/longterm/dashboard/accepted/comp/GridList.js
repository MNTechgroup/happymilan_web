                                    ...
                                    <div style={ProfileCard} className='inline-block lg:flex flex-col space-y-[15px]  2xl:w-[192px] w-[180px] xl:w-[170px] h-[327px] bg-[#FFF] rounded-[10px]'>
                                        <div className='flex justify-between pt-[10px]'>
                                            ...
                                            <ul className='pr-[10px] flex space-x-[30px]'>
                                                <li>
                                                    <Image loading='lazy' alt="star" width={15} height={14} src='/assests/Black/Stars-2.svg' />
                                                </li>
                                                <li>
                                                    <Image loading='lazy' alt="dots" width={3} height={14} src='/assests/Black/3Dots.svg' />
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className='flex space-x-[15px] justify-center'>
                                            ...
                                            <div><Image loading='lazy' alt="heart" width={40} height={40} className='w-[40px] h-[40px]' src='/assests/dashboard/icon/heart-icon-2.svg' /></div>
