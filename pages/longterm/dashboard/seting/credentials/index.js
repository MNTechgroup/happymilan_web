...
import Credentials from './comp/Credential';
const BackButton = dynamic(() => import('../comp/BackButton'));
// const Credential = dynamic(() => import('./comp/Credential'));
            ...
            <div className='w-full h-full grid place-items-center'>
                ...
                <div className='hidden md:block w-[90%] mt-[120px] '>
                    ...
                    <div className='flex mt-[20px]'>
                        ...
                        <main className=' absolute ml-[25%] lg:ml-[23%] xl:ml-[330px]'><Credentials /></main>
                    </div>
                </div>
