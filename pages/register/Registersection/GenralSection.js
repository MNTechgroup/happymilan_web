...
function GenralSection({ SetActiveTab }) {
        ...
        <>
            <div>
                <div className='flex justify-evenly items-center h-screen'>
                    <div className=''>
                        <ul className='w-[332px] space-y-[40px]'>
                            <li className='space-y-[11px]'>
                                <h1 style={Title}>General Details</h1>
                                <p style={Content}>Welcome to Matrimoney, the premier online platform for finding your perfect life partner! </p>
                            </li>
                            <li>
                                            ...
                                            <div className="">
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        name="aboutyourself"
                                                        type="text"
                                                        className="w-[647px] border-b border-[#C0C0C0] py-1 focus:border-b-2 focus:border-[#000] transition-colors focus:outline-none peer bg-inherit"
                                                        placeholder=" "
                                                    />
